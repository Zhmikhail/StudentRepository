...
public class CSVUtil {
    public static List<Data> readFromCSV(String filePath) throws IOException {
    ...
    public static void writeToCSV(String filePath, List<Data> dataList) throws IOException {
