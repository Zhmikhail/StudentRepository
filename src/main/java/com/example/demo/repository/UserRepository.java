...
public class UserRepository {
    ...
    public enum QueryType {
        SELECT_ALL_USERS(String.format("SELECT * FROM Users u JOIN position p ON p.%s = u.position_id", UserRowMapper.TableFields.ID.getTableField())), SELECT_USER(String.format("SELECT * FROM Users u JOIN position p on p.%s = u.position_id WHERE u.%s = ?", UserRowMapper.TableFields.ID.getTableField(), UserRowMapper.TableFields.ID.getTableField())), SAVE_USER(String.format("INSERT INTO Users (%s, %s, %s, %s, %s, %s, %s) VALUES (?, ?, ?, ?, ?, ?, ?)", UserRowMapper.TableFields.FIRST_NAME.getTableField(), UserRowMapper.TableFields.LAST_NAME.getTableField(), UserRowMapper.TableFields.BIRTH_DATE.getTableField(), UserRowMapper.TableFields.POSITION_ID.getTableField(), UserRowMapper.TableFields.SALARY.getTableField(), UserRowMapper.TableFields.HIRE_DATE.getTableField(), UserRowMapper.TableFields.FIRE_DATE.getTableField())), UPDATE_USER(String.format("UPDATE Users SET %s = ?, %s = ?, %s = ?, %s = ?, %s = ?, %s = ?, %s = ? WHERE %s = ?", UserRowMapper.TableFields.FIRST_NAME.getTableField(), UserRowMapper.TableFields.LAST_NAME.getTableField(), UserRowMapper.TableFields.BIRTH_DATE.getTableField(), UserRowMapper.TableFields.POSITION_ID.getTableField(), UserRowMapper.TableFields.SALARY.getTableField(), UserRowMapper.TableFields.HIRE_DATE.getTableField(), UserRowMapper.TableFields.FIRE_DATE.getTableField(), UserRowMapper.TableFields.ID.getTableField())), DELETE_USER(String.format("DELETE FROM Users WHERE %s = ?", UserRowMapper.TableFields.ID.getTableField()));
